...
OFILES = Paused.o Blocks.o Pieces.o GameBackend.o myLib.o Tetris.o Numbers.o GameplayBackground.o PlayingBlock.o GameOver.o Game.o GameOverBlock.o Start.o StartBlock.o StartArrow.o StartArrowBackground.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = Paused.h Blocks.h Pieces.h GameBackend.h myLib.h Numbers.h GameplayBackground.h Playingblock.h GameOver.h Game.h GameOverBlock.h Start.h StartBlock.h StartArrow.h StartArrowBackground.h
